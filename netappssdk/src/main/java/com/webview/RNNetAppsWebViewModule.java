...
@ReactModule(name = RNNetAppsWebViewModule.MODULE_NAME)
public class RNNetAppsWebViewModule extends ReactContextBaseJavaModule implements ActivityEventListener {
  public static final String MODULE_NAME = "RNNetAppsWebView";
  ...
  public RNNetAppsWebViewModule(ReactApplicationContext reactContext) {
    super(reactContext);
  ...
  public void startPhotoPickerIntent(ValueCallback<Uri> filePathCallback, String acceptType) {
    ...
    if (chooserIntent.resolveActivity(getCurrentActivity().getPackageManager()) != null) {
      ...
      Log.w("RNNetAppsWebViewModule", "there is no Activity to handle this Intent");
    }
  }
  ...
  public void downloadFile(String downloadingMessage) {
    ...
    try {
      ...
      Log.w("RNNetAppsWebViewModule", "Unsupported URI, aborting download", e);
      return;
    }
